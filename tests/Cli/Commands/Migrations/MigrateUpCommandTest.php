...
use App\Cli\Commands\Migrations\MigrateUpCommand;
...
class MigrateUpCommandTest extends TestCase
{
    /** @var mixed[] */
    ...
    public function test(): void
    {
        ...
        $command = new MigrateUpCommand(
            $this->mockPhinxApplication()
        );

        self::assertSame('migrate:up', $command->getName());
